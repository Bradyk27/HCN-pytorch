...
"""
@author: huguyuehuhu, edits by bradyk27
@time: 18-3-25 下午3:54
...
parser.add_argument('--dataset_dir', default='lidar_mocap', help="root directory for all the datasets")
parser.add_argument('--dataset_name', default='lidar_mocap', help="dataset name ") # NTU-RGB-D-CS,NTU-RGB-D-CV
